...
//
// hsmctl --help                       ✓
// hsmctl --help unexpected-argument   ✓
//
TEST_CASE("help")
{
    SECTION("success")
    ...
    {
        const char* argv[] = {"hsmctl", "--help", "unexpected-argument"};
...
// hsmctl status                            ✓
// hsmctl status --help                     ✓
// hsmctl status --help unexpected-argument ✓
// hsmctl status unexpected-argument        ✓
//
TEST_CASE("status")
{
    SECTION("success")
    ...
    SECTION("help")
    {
        ...
        SECTION("unexpected argument")
        {
            const char* argv[] = {"hsmctl", "status", "--help", "unexpected-argument"};
    ...
    SECTION("unexpected argument")
    {
        const char* argv[] = {"hsmctl", "status", "unexpected-argument"};
...
// hsmctl logs                              ✓
// hsmctl logs --help                       ✓
// hsmctl logs --help unexpected-argument   ✓
// hsmctl logs unexpected-argument          ✓
//
TEST_CASE("logs")
{
    SECTION("success")
    ...
    SECTION("help")
    {
        ...
        SECTION("unexpected-argument")
        {
            const char* argv[] = {"hsmctl", "logs", "--help", "unexpected-argument"};
    ...
    SECTION("unexpected argument")
    {
        const char* argv[] = {"hsmctl", "logs", "unexpected-argument"};
...
// Possible commands:
//
// hsmctl erase-key --slot <non-boundary slot>      ✓
// hsmctl erase-key --slot <lower boundary slot>    ✓
// hsmctl erase-key --slot <upper boundary slot>    ✓
// hsmctl erase-key                                 ✓
// hsmctl erase-key --help                          ✓
// hsmctl erase-key --help unexpected-argument      ✓
// hsmctl erase-key --invalid-option                ✓
// hsmctl erase-key --slot                          ✓
// hsmctl erase-key --slot NaN                      ✓
// hsmctl erase-key --slot <out of boundary slot>   ✓
// hsmctl erase-key --slot 1 --slot 2               ✓
// hsmctl erase-key --slot 1 unexpected-argument    ✓
//
TEST_CASE("erase key")
{
    SECTION("success")
    ...
    SECTION("help")
    {
        ...
        SECTION("unexpected argument")
        {
            const char* argv[] = {"hsmctl", "erase-key", "--help", "unexpected-argument"};
    ...
    SECTION("invalid option")
    {
        ...
        SECTION("unexpected argument")
        {
            const char* argv[] = {"hsmctl", "erase-key", "--slot", "0", "unexpected-argument"};
...
// hsmctl generate-key --help unexpected-argument
// hsmctl generate-key
// hsmctl generate-key
// hsmctl generate-key
// hsmctl generate-key
...
TEST_CASE("generate key")
{
    SECTION("success")
    {
        ...
        SECTION("specified curve")
        {
            ...
            SECTION("P-256")
            {
                const char* argv[] = {"hsmctl", "generate-key", "--slot", "18", "--curve", "p256"};
            ...
            {
                const char* argv[] = {"hsmctl", "generate-key", "--curve", "p256", "--slot", "16"};
